...
from app.contextualizer import get_optimized_layout
...
async def process_file(
    ...
    try:
        ...
        # Get the optimized layout from the AI
        optimized_elements = get_optimized_layout(info["classified"]["elements"])
        info["classified"]["elements"] = optimized_elements
